...
var Device_GL = /** @class */ (function () {
    ...
    Device_GL.prototype.applyStencil = function () {
        ...
        this.gl.stencilFuncSeparate(exports.GL.FRONT, this.currentMegaState.stencilFront.compare, this.currentStencilRef, 0xff);
        this.gl.stencilFuncSeparate(exports.GL.BACK, this.currentMegaState.stencilBack.compare, this.currentStencilRef, 0xff);
    };
